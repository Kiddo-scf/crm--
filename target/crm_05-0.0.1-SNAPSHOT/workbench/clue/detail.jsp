...
<script type="text/javascript">
	...
	$(function(){
		...
		//页面加载完毕后，取出线索关联的市场活动列表
		showActivityList();

		//为关联市场活动模态窗口的的搜索框绑定事件，通过出发回车键，查询并展现市场活动列表
		...
		$("#bindBtn").click(function () {
			...
			if(choosed.length==0){
				...
				for (var i=0;i<choosed.length;i++){
					...
					param += 'aid='+$(choosed[i]).val();

					if(i<choosed.length-1){
						param += '&';
					}
				}
				$.ajax({
					...
					success:function (data){
						...
						if(data.success){
							...
							//清除搜索框中的信息 取消复选框中的√ 情况activitySerachBody中的内容
	...
	//id是tbl_clue_activity_relation的id
	function unbind(id){
		$.ajax({
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-email" value="hh@fs.com">
                            </div>
                        </div>
