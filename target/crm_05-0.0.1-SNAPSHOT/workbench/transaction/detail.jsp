...
<%@ page import="com.fs.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="javax.print.StreamPrintService" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.fs.crm.workbench.domain.Tran" %>
	...
	function changeStage(stage,i){
		...
		$.ajax({
			...
			success:function (data){
				...
				//data:{"success":true/false,"tran":{交易}}
				if (data.success){
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
						//如果便利出来的阶段的可能性不为0,说明是前7个阶段 绿圈，绿色标记，黑圈
						}else {
						//如果是当前阶段
						if (i==index){
