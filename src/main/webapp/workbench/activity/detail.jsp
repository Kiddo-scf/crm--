            ...
            $.ajax({
                ...
                success:function (data){
                    ...
                    if(data.success){
                        ...
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                        html += '<a class="myHref" href="javascript:void(0);"><span onclick="deleteRemark(\''+data.activityRemark.id+'\')" class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
                        html += '</div>';
                        html += '</div>';
                        html += '</div>';
            ...
            $.ajax({
                ...
                success:function (data){
                    ...
                    * */
                    ...
                    //更新div中的信息，需要更新noteContent,editTime,editBy
	...
	function showRemarkList(){
		$.ajax({
			...
			success:function (data){
				var html = "";
				/*
				data:{{reamrk1},{remark2}}
				* */
				//每个n是一个activityRemark对象
				...
				html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
				html += '<a class="myHref" href="javascript:void(0);"><span onclick="editRemark(\''+n.id+'\')" class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>';
				html += '&nbsp;&nbsp;&nbsp;&nbsp;';
