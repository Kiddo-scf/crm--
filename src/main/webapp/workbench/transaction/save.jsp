...
<script>
	...
	$(function (){
		...
		$("#create-stage").change(function () {
			...
			有了stage,需要先将pMap转换为json才能取值
			以上已转换

			但是现在以json.key形式不能取得value
			因为stage是一个变量,无法以传统的json.key形式来取值
			需要使用json[key]
			 */
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal"role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单666">
				<input type="hidden" name="activityId" value="57f73255f5e84040b39bc5b970f14c4f">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="a28fb623fb524d26820c3217741e566a">
			</div>
		</div>
